...
class PressServiceFragment : Fragment(), OnClickNewsListener {
    ...
    override fun onCreateView(inflater: LayoutInflater,container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.newsRecyclerView.adapter = NewsAdapter(listOfNews, this)
        return binding.root
    }

    override fun onClick(news: News) {
        val action = PressServiceFragmentDirections.actionPressServiceFragmentToNewsDialog(news)
